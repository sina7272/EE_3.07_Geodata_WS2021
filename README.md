...
The course uses **open environmental data** to introduce concepts, study problems and develop solutions. Data sources are for example the [**open geodata archive NRW**](https://www.opengeodata.nrw.de/produkte/) of the federal state North Rhine-Westphalia (NRW) as well as the [**DWD climate data center**] of the German Weather Service. 
